...
export default function CursorBlend() {
  ...
  return (
    <section className="section h-screen bg-black">
      <motion.div
        animate={{
          WebkitMaskPosition: `${mousePosition.x - cursorSize / 2}px ${
            mousePosition.y - cursorSize / 2
          }px`,
        ...
        className="mask w-full h-full flex items-center justify-center text-[#afa18f] text-6xl leading-[66px] cursor-default"
      >
        <p
